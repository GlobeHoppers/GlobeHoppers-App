...
function sortKeyFor(trip, start) {
  if (trip?.sort_order != null) {
    return `${String(start.year || 9999).padStart(4, '0')}-${String(start.month || 99).padStart(2, '0')}-${String(start.day || 99).padStart(2, '0')}-${String(trip.sort_order).padStart(6, '0')}`;
  }
  return `${String(start.year || 9999).padStart(4, '0')}-${String(start.month || 99).padStart(2, '0')}-${String(start.day || 99).padStart(2, '0')}-${trip.id}`;
}
