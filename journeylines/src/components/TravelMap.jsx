...
function addRouteSourcesAndLayers(map) {
  ...
  if (!map.getSource('completed-routes')) {
    ...
    map.addLayer({ id: 'completed-routes-tube-shadow', type: 'line', source: 'completed-routes', layout: { 'line-cap': 'round', 'line-join': 'round' }, paint: { 'line-color': '#02050a', 'line-width': ['*', widthExpr('width'), 0.74], 'line-opacity': ['*', opacityExpr('opacity'), ['case', ['==', ['get', 'trailRole'], 'border'], 0, ['==', ['get', 'trailRole'], 'separator'], 0, 0.52]], 'line-blur': 0.24, 'line-offset': ['+', ['coalesce', ['get', 'lineOffset'], 0], 1.18] } });
    ...
    map.addLayer({ id: 'completed-routes-sheen', type: 'line', source: 'completed-routes', layout: { 'line-cap': 'round', 'line-join': 'round' }, paint: { 'line-color': '#ffffff', 'line-width': ['*', widthExpr('width'), 0.34], 'line-opacity': ['*', opacityExpr('opacity'), ['case', ['==', ['get', 'trailRole'], 'border'], 0, ['==', ['get', 'trailRole'], 'separator'], 0, 0.62]], 'line-blur': 0.16, 'line-offset': ['+', ['coalesce', ['get', 'lineOffset'], 0], -1.04] } });
    map.addLayer({ id: 'completed-routes-rim-light', type: 'line', source: 'completed-routes', layout: { 'line-cap': 'round', 'line-join': 'round' }, paint: { 'line-color': ['case', ['==', ['get', 'trailRole'], 'border'], 'transparent', '#dff7ff'], 'line-width': ['*', widthExpr('width'), 0.18], 'line-opacity': ['*', opacityExpr('opacity'), ['case', ['==', ['get', 'trailRole'], 'border'], 0, ['==', ['get', 'trailRole'], 'separator'], 0, 0.76]], 'line-blur': 0.08, 'line-offset': ['+', ['coalesce', ['get', 'lineOffset'], 0], -1.48] } });
  }
  if (!map.getSource('active-route')) {
    ...
    map.addLayer({ id: 'active-route-tube-shadow', type: 'line', source: 'active-route', layout: { 'line-cap': 'round', 'line-join': 'round' }, paint: { 'line-color': '#02050a', 'line-width': ['*', widthExpr('width'), 0.78], 'line-opacity': ['*', opacityExpr('opacity'), ['case', ['==', ['get', 'trailRole'], 'border'], 0, ['==', ['get', 'trailRole'], 'separator'], 0, 0.62]], 'line-blur': 0.22, 'line-offset': ['+', ['coalesce', ['get', 'lineOffset'], 0], 1.22] } });
    ...
    map.addLayer({ id: 'active-route-sheen', type: 'line', source: 'active-route', layout: { 'line-cap': 'round', 'line-join': 'round' }, paint: { 'line-color': '#ffffff', 'line-width': ['*', widthExpr('width'), 0.36], 'line-opacity': ['*', opacityExpr('opacity'), ['case', ['==', ['get', 'trailRole'], 'border'], 0, ['==', ['get', 'trailRole'], 'separator'], 0, 0.70]], 'line-blur': 0.14, 'line-offset': ['+', ['coalesce', ['get', 'lineOffset'], 0], -1.08] } });
    map.addLayer({ id: 'active-route-rim-light', type: 'line', source: 'active-route', layout: { 'line-cap': 'round', 'line-join': 'round' }, paint: { 'line-color': ['case', ['==', ['get', 'trailRole'], 'border'], 'transparent', '#e9fbff'], 'line-width': ['*', widthExpr('width'), 0.20], 'line-opacity': ['*', opacityExpr('opacity'), ['case', ['==', ['get', 'trailRole'], 'border'], 0, ['==', ['get', 'trailRole'], 'separator'], 0, 0.82]], 'line-blur': 0.06, 'line-offset': ['+', ['coalesce', ['get', 'lineOffset'], 0], -1.56] } });
  }
