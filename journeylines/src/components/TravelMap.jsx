...
function addRouteSourcesAndLayers(map) {
  ...
  if (!map.getSource('completed-routes')) {
    ...
    map.addLayer({ id: 'completed-routes-sheen', type: 'line', source: 'completed-routes', layout: { 'line-cap': 'round', 'line-join': 'round' }, paint: { 'line-color': '#ffffff', 'line-width': ['*', widthExpr('width'), 0.26], 'line-opacity': ['*', opacityExpr('opacity'), ['case', ['==', ['get', 'trailRole'], 'border'], 0, ['==', ['get', 'trailRole'], 'separator'], 0, 0.22]], 'line-blur': 0.65, 'line-offset': ['+', ['coalesce', ['get', 'lineOffset'], 0], -0.42] } });
  }
  if (!map.getSource('active-route')) {
    ...
    map.addLayer({ id: 'active-route-sheen', type: 'line', source: 'active-route', layout: { 'line-cap': 'round', 'line-join': 'round' }, paint: { 'line-color': '#ffffff', 'line-width': ['*', widthExpr('width'), 0.28], 'line-opacity': ['*', opacityExpr('opacity'), ['case', ['==', ['get', 'trailRole'], 'border'], 0, ['==', ['get', 'trailRole'], 'separator'], 0, 0.28]], 'line-blur': 0.6, 'line-offset': ['+', ['coalesce', ['get', 'lineOffset'], 0], -0.46] } });
  }
